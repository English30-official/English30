...
export default function App() {
  ...
  const { session, isLoading: authLoading, isConfigured, isStaff } = useAuth();
  ...
  if (appMode === 'owner' && isStaff) return <OwnerDashboard onSwitchToStudentView={() => setAppMode('student')} />;
